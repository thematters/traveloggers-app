            ...
            <Section.Content>
              <p>
                {locale === Lang.en
                  ...
                  : `我們為遠航者創造了6個基礎人物，分別是 Sasha（薩沙）、Zhenya（振亞）、Valya（瓦拉）、Gena（根那）、Lesya（列峽）、Yury（尤里）。同時我們根據創作者的價值取向，哲學主張，創作者的創作氣質，思考方式，創作者的創作習慣和個性等6個維度，提取關鍵詞進行設計， 生成了 xxx 個 CryptoMatties。每一個 CryptoMatties 都有專屬的創作者屬性，都是獨一無二的。`}
              </p>
            </Section.Content>
          </section>
        </section>
