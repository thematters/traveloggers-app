const TEXTS: Record<string, any> = {
  zh: {
    title: "關於 Matters Lab",
    content1:
      "Matters Lab 成立於 2018 年，致力於搭建 Web3 環境中，更自由與公平的創作者生態。其中，包含使用去中心技術工具，" +
      "完成數字權利的確認、治理制度的設計、創作者經濟模型搭建。",
    content2:
      "Matters.Town 是 Matters Lab 的第一站，它是 Web3 世界最大的、開源的去中心化出版平台，已有 8 萬名註冊寫作者。" +
      "Avatar-Traveloggers 計畫是 Matters Lab 的第二站，" +
      "目標是探索創作者經濟模型。Matters Lab 還即將推出 The Space 計畫，致力於以激進市場法則探索公共治理。",
    button: "更多資訊",
  },
  en: {
    ...
    content2:
      "Matters.Town is the first entrance of Matters Lab. It is the largest open-source decentralized publishing platform " +
